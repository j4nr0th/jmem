...
int main()
{
    ...
    {
        assert(ill_allocator_verify(allocator, NULL, NULL) == 0);
        pointer_array[i] = ill_alloc(allocator, 32);
        assert(ill_allocator_verify(allocator, NULL, NULL) == 0);
    ...
    allocator = ill_allocator_create(64, 1);
    assert(allocator);
    for (u32 i = 0; i < 1024; ++i)
    {
        pointer_array[i] = ill_alloc(allocator, 8);
    ...
    {
        assert(ill_allocator_verify(allocator, NULL, NULL) == 0);
        pointer_array[i] = ill_alloc(allocator, 16);
        assert(ill_allocator_verify(allocator, NULL, NULL) == 0);
    ...
    allocator = ill_allocator_create(1024, 32);
    assert(allocator);
    ...
    pointer_array[1023] = ill_alloc(allocator, 6);
    ...
    allocator = ill_allocator_create(1 << 20, 1);
    assert(allocator);

    memset(pointer_array, 0, sizeof(pointer_array));
    assert(ill_allocator_verify(allocator, NULL, NULL) == 0);
    pointer_array[0] = ill_alloc(allocator, 128);
    assert(ill_allocator_verify(allocator, NULL, NULL) == 0);
    pointer_array[1] = ill_alloc(allocator, 128);
    assert(ill_allocator_verify(allocator, NULL, NULL) == 0);
    pointer_array[2] = ill_alloc(allocator, 128);
    assert(ill_allocator_verify(allocator, NULL, NULL) == 0);
    ...
    {
        assert(ill_allocator_verify(allocator, NULL, NULL) == 0);
        void* p1 = ill_alloc(allocator, 32);
        assert(ill_allocator_verify(allocator, NULL, NULL) == 0);
        void* p2 = ill_alloc(allocator, 32);
        assert(ill_allocator_verify(allocator, NULL, NULL) == 0);
        void* p3 = ill_alloc(allocator, 32);
        assert(ill_allocator_verify(allocator, NULL, NULL) == 0);
    ...
    {
        assert(ill_allocator_verify(allocator, NULL, NULL) == 0);
        void* p1 = ill_alloc(allocator, 128);
        assert(ill_allocator_verify(allocator, NULL, NULL) == 0);
        memset(p1, 0xCC, 128);
        assert(ill_allocator_verify(allocator, NULL, NULL) == 0);
    ...
    allocator = ill_allocator_create(1 << 10, 1);
    assert(allocator);
    assert(ill_allocator_verify(allocator, NULL, NULL) == 0);

    {
        void* mem1,* mem2, *mem3;
        mem1 = ill_alloc(allocator, (1 << 9) - 8);
        assert(ill_allocator_verify(allocator, NULL, NULL) == 0);
        mem2 = ill_alloc(allocator, (1 << 9) - 16);
        assert(ill_allocator_verify(allocator, NULL, NULL) == 0);
        mem3 = ill_alloc(allocator, (1 << 10) - 16);
        assert(ill_allocator_verify(allocator, NULL, NULL) == 0);
        ...
        mem1 = ill_alloc(allocator, (1 << 10) - 16);
        assert(ill_allocator_verify(allocator, NULL, NULL) == 0);
...

    {
        ...
        mem1 = ill_alloc(allocator, 128);
        assert(ill_allocator_verify(allocator, NULL, NULL) == 0);
        mem2 = ill_alloc(allocator, 64);
        assert(ill_allocator_verify(allocator, NULL, NULL) == 0);
        mem3 = ill_alloc(allocator, 128);
        assert(ill_allocator_verify(allocator, NULL, NULL) == 0);
        mem4 = ill_alloc(allocator, 128);
        assert(ill_allocator_verify(allocator, NULL, NULL) == 0);
