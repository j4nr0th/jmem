 ...
 * @param ptr NULL or a valid pointer to a block previously allocated by lin_alloc or lin_jrealloc
...
/**
 * Restores the current allocator base, which was returned by a previous call to lin_allocator_save_state
