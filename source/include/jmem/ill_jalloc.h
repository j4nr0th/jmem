...
#ifndef JMEM_ILL_JALLOC_H
#define JMEM_ILL_JALLOC_H
#ifndef _WIN32
#define _GNU_SOURCE
#endif
#include <stdint.h>
...
void ill_jallocator_set_bad_alloc_callback(ill_jallocator* allocator, void(*callback)(ill_jallocator* allocator, void* param), void* param);

void ill_jallocator_set_double_free_callback(ill_jallocator* allocator, void(*callback)(ill_jallocator* allocator, void* param), void* param);

#endif //JMEM_ILL_JALLOC_H
